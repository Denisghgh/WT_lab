...
<?php
$arr = ['ЯНВАРЯ', 'ФЕВРАЛЯ', 'МАРТА', 'АПРЕЛЯ', 'МАЯ', 'ИЮНЯ', 'ИЮЛЯ', 'АВГУСТА', 'СЕНБТЯБРЯ', 'ОКТЯБРЯ', 'НОЯБРЯ', 'ДЕКАБРЯ'];
		...
		<form method="GET">
			...
			<?php
			    if (isset($_GET['date'])){
					...
					echo date("d",strtotime($date))." ".$arr[date('n', strtotime($date))-1]." ".date("Y",strtotime($date));
				}	
            ?>
		</h4>
    </body>
